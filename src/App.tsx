      ...
      <div className="container">
        <div className="side-bar-container">
          ...
          <div className="header-section">
            ...
            <p style={{ opacity: '100%' }}>Software Engineer with 4+ years of experience building mission-critical full-stack systems. Proven track record of developing secure, high-stakes software. Specializing in Python, Ruby on Rails, and AWS to build scalable architectures for computer vision and sensor-driven data.</p>
